...
> 最后更新：2026-08-25（M6.4 退款成功审计已人工验收；补充已真机验证的生产部署图文手册）
...
| M6 | v1.1 硬化（审计/签名/i18n/法律模板/Woo导入/S3）+ 验收 | 🟡 进行中（M6.1 审计日志地基 ✅ 已验收合主干；M6.2 关键后台操作审计 ✅ 已验收合主干；M6.3 配置变更审计 ✅ 已验收合主干；M6.4 退款成功审计 ✅ 已验收） |
