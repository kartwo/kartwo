...
function describe(event) {
  const labels = {
    ...
    'product.update': '更新商品',
    'product.delete': '删除商品',
    'category.create': '新建商品分类',
    'category.update': '更新商品分类',
    'category.delete': '删除商品分类',
    ...
    'payment.stripe_connection_test': '测试 Stripe 连接',
    'shop.settings_update': '更新店铺名称',
    'shop.logo_upload': '上传店铺 Logo',
    'shop.logo_delete': '删除店铺 Logo',
    'domain.settings_update': '更新域名设置',
    'market.settings_update': '更新市场设置',
    'smtp.settings_update': '更新邮件设置',
    'order.refund': '退款订单',
    'order.export': '导出订单 CSV',
    'media.upload': '上传商品图片',
    'media.delete': '删除商品图片',
    'export.create': '生成数据导出包',
    'shipping.countries_update': '更新可配送国家',
    'shipping.default_update': '更新默认运费',
